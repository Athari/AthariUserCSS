...
export const kw = new class {
  ...
  readonly unit = new class {
    ...
    readonly allAbsolute = [ ...this.angle, ...this.frequency, ...this.resolution, ...this.time, ...this.length.absolute ] as const;
    readonly all = [ ...this.angle, ...this.frequency, ...this.percent, ...this.resolution, ...this.time, ...this.length.all ] as const;
  };
  ...
  readonly prop = new class {
    readonly font = new class {
      ...
      readonly shorthandSub = [ this.family, this.size, this.stretch, this.style, this.variant, this.weight, this.lineHeight ] as const;
      readonly all = [ this.shorthand, ...this.shorthandSub ] as const;
    };
  };
...
export namespace Prop {
  export namespace Font {
    export type AnyShorthand = typeof kw.prop.font.shorthandSub[number];
  }
}
